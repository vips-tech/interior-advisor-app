import { a as BaseContext, n as Middleware, o as FetchHandler } from "../../define-middleware-xEwn-tIK.cjs";
...
interface WithFeatureFlagConfig {
   ...
   * before it.
   */
  evaluate: (req: Request, ctx: BaseContext) => Promise<boolean | FeatureFlagVerdict> | boolean | FeatureFlagVerdict;
  /**
