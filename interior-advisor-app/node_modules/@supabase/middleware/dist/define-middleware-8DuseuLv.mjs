import { env, isDeno, runtime } from "std-env";
...
function getEnv(key) {
	...
	const fromStd = env[key];
	if (fromStd !== void 0) return fromStd;
	if (isDeno) return globalThis.Deno?.env?.get(key);
}
/**
...
//#endregion
export { runtimeName as a, isContext as i, bufferRequest as n, seedContext as o, getEnv as r, defineMiddleware as t };