...
const require_sql = require("../../sql-M9W4VQsg.cjs");
...
const withPostgresClient = (0, _supabase_middleware.defineMiddleware)({
	key: "postgres",
	run: (config) => {
		const poolOptions = require_sql.resolvePoolOptions(config?.pool);
		return async (_req, ctx) => {
			...
			const p = require_sql.getPool(connectionString, poolOptions);
