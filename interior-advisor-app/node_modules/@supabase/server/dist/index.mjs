import { a as preAuthName, i as fromSupabaseUrl, n as resourceMetadataResponse, r as unauthorizedResponse, t as withOAuthProtectedResource } from "./with-oauth-protected-resource-DVUriq5X.mjs";
import { C as NoKeysConfiguredError, D as SupabaseServerError, E as PostgresPoolError, O as UnsupportedRoleError, S as MissingSupabaseURLError, T as PostgresPoolBusyError, _ as MissingDefaultPublishableKeyError, a as EnvGenericError, b as MissingResourceServerError, c as Errors, d as InvalidJwtError, f as JwksFetchFailedError, g as MissingCredentialsError, h as MissingConnectionStringError, i as EnvError, k as UnusableCredentialError, l as InvalidApiKeyError, m as MissingAuthorizationServerError, n as AuthGenericError, o as ErrorCodeHeader, p as JwksNotConfiguredError, r as CreateSupabaseClientError, s as ErrorSource, t as AuthError, u as InvalidCredentialsError, v as MissingDefaultSecretKeyError, w as PostgresConnectPausedError, x as MissingSecretKeyError, y as MissingPublishableKeyError } from "./errors-COrw6ceS.mjs";
import { t as errorResponse } from "./error-response-C9NvHvIq.mjs";
import { n as isConstructionFailure, t as constructionFailureResponse } from "./construction-failure-C1_1KeBa.mjs";
import { t as verifyAuth } from "./verify-auth-DUhipngq.mjs";
import { t as withSupabaseAdminClient } from "./admin-client-BioZ1mMU.mjs";
import { withSupabaseClient } from "./middleware/client/index.mjs";
import { t as createSupabaseContext } from "./create-supabase-context-DDNMr22i.mjs";
...
//#endregion
export { AuthError, AuthGenericError, CreateSupabaseClientError, EnvError, EnvGenericError, ErrorCodeHeader, ErrorSource, Errors, InvalidApiKeyError, InvalidCredentialsError, InvalidJwtError, JwksFetchFailedError, JwksNotConfiguredError, MissingAuthorizationServerError, MissingConnectionStringError, MissingCredentialsError, MissingDefaultPublishableKeyError, MissingDefaultSecretKeyError, MissingPublishableKeyError, MissingResourceServerError, MissingSecretKeyError, MissingSupabaseURLError, NoKeysConfiguredError, PostgresConnectPausedError, PostgresPoolBusyError, PostgresPoolError, SupabaseServerError, UnsupportedRoleError, UnusableCredentialError, createSupabaseContext, fromSupabaseUrl, resourceMetadataResponse, unauthorizedResponse, withOAuthProtectedResource, withSupabase };
